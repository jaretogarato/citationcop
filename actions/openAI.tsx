...
export async function verifyGoogleSearchResultWithLLM(reference: Reference, searchResults: any): Promise<{ isValid: boolean, message: string }> {
  ...
  const reference_string = [
    ...
    .join(" ");
  //console.log("Reference String:", reference_string);
...
Answer in the following format:
{
  ...
  "message": "Explain how the search results verify or not the given refernece. Provide evidence. Provide your degree of confidence.",
}`;
