  ...
  const userTypes = [
    {
      ...
      title: 'Educators',
      description:
        'Efficiently validate student submissions and academic work, saving hours of manual verification time',
      example:
        'Like Prof. Johnson, who caught 23 incorrect citations in one semester using automated verification'
    },
    {
      icon: Brain,
      title: 'Content Creators',
      description:
        'Verify AI-generated references instantly to ensure your content maintains credibility and accuracy',
      example:
    ...
    },
    {
      ...
      example:
        "Like Nature's peer reviewers, who reduced reference checking time by 75% using SourceVerify"
    },
    {
      icon: Building2,
      title: 'Research Funders',
      description:
        'Evaluate grant proposals with confidence by automatically validating publication records and citations',
      example:
        'Like the NSF, who verified 1000+ researcher publications across 50 grant proposals in one day'
    },
    {
      icon: Users,
      title: 'HR Teams',
      description:
        "Verify academic credentials and publication lists when evaluating candidates' CVs and resumes",
      example:
        "Like Tesla's HR team, who validated 100+ researcher CVs for their AI division in hours, not weeks"
    },
    {
      icon: FileCheck,
      title: 'Publishers',
  ...
  return (
    <section className="max-w-6xl mx-auto px-8 py-16">
      ...
      <p className="text-xl text-indigo-300 text-center mb-16 max-w-2xl mx-auto">
        From content creation to academic integrity, SourceVerify helps
        professionals across industries validate references with confidence.
      </p>
              ...
              >
                <div className="bg-gray-800/50 backdrop-blur-sm p-8 border border-indigo-500/20">
                  <div className="flex items-center mb-6">
                    ...
                    <h3 className="text-2xl text-white font-semibold ml-4">
                      {type.title}
                    </h3>
                  </div>
