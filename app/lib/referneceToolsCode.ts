...
interface FetchConfig {
  ...
  export async function checkDOI(doi: string, title: string, config: FetchConfig = {}) {
    try {
  ...
  export async function searchReference(reference: string, config: FetchConfig = {}) {
    try {
  ...
  export async function checkURL(url: string, reference: string, config: FetchConfig = {}) {
    try {
